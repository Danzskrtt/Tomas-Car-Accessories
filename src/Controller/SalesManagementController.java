...
public class SalesManagementController {
    ...
    private void generateOrderNumber() {
        ...
        currentOrderNumber = String.format("ORD-%06d", number);
    ...
    private void processSale() {
        ...
        try {
            ...
            PreparedStatement stockStmt = conn.prepareStatement(stockQuery);
             ...
             // Prepare statement for inventory transaction logging
             String txQuery = "INSERT INTO stock_transactions (product_id, transaction_type, quantity, reference_number, supplier, user_id, notes) VALUES (?, 'OUT', ?, ?, ?, ?, ?)";
             ...
             for (CartItem item : cartItems) {
                 ...
                 txStmt.setInt(1, item.getProductId());
                 txStmt.setInt(2, item.getQuantity());
                 txStmt.setString(3, "ORD-" + currentOrderNumber);
                 txStmt.setString(4, "");
                 txStmt.setInt(5, UserSession.getInstance().getUserId() > 0 ? UserSession.getInstance().getUserId() : 1);
                 txStmt.setString(6, "Sale - Order #" + currentOrderNumber);
